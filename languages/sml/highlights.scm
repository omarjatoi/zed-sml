...
([(vid) (tycon) (strid) (sigid) (fctid)] @constructor
 (#any-of? @constructor
           ;; Reserved Words Core
           "abstype" "and" "andalso" "as" "case" "datatype" "do" "else" "end"
           "exception" "fn" "fun" "handle" "if" "in" "infix" "infixr" "let"
...
[(strid) (sigid) (fctid)] @attribute

;; Extras
(fmrule name: (vid) @function.definition)
(datbind name: (tycon) @constructor)
(fmrule arg: (vid_pat) @property)
(fmrule arg: (paren_pat) @property)
(typbind name: (tycon) @constructor)
